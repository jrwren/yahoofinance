...
{
    public class CompanyCompetitorsQuery : Query<CompanyCompetitorsResult>, IYqlQuery
    {
        ...
        public CompanyCompetitorsQuery() : this(string.Empty) { }
        public CompanyCompetitorsQuery(string id) { this.ID = id; }
        ...
        {
            string url = string.Format("http://finance.yahoo.com/q/co?s={0}", this.ID);
        ...
        protected override CompanyCompetitorsResult ConvertResult(System.IO.Stream stream)
        {
            CompanyCompetitorsResult result = new CompanyCompetitorsResult();
        ...
        public override Query<CompanyCompetitorsResult> Clone()
        {
            return new CompanyCompetitorsQuery() { ID = this.ID, GetDiagnostics = this.GetDiagnostics, UseDirectSource = this.UseDirectSource };
        }
    ...
    /// </summary>
    public class CompanyCompetitorsResult : IYqlResult
    {
